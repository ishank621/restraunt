...
import { Breadcrumb, BreadcrumbItem, Button, Col, Label, Row } from "reactstrap"; {/*Input,FormFeedback,Form, FormGroup*/}

const required = (val) => val && val.length;//checking value is greater than 0
...
class Contact extends Component{
  ...
  //   this.setState({
  //     touched: {...this.statetouched, [field]: true} //... means for all those, => means for which
  //   });
  // }
